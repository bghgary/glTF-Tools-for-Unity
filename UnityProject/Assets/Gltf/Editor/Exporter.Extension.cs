...
namespace Gltf.Serialization
{
    internal sealed partial class Exporter
    {
        private abstract class Extension
        {
            ...
            public virtual bool ExportTexture(Texture2D unityTexture, bool normalMap, out int index) { index = -1; return false; }
            ...
            public virtual void PostExportTexture(int index, Texture2D unityTexture, bool normalMap) { }
